...
func UpdJobSkillsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdUserCompanySkillsReq
		...
		l := usercompany.NewUpdJobSkillsLogic(r.Context(), svcCtx)
		resp, err := l.UpdJobSkills(&req)
