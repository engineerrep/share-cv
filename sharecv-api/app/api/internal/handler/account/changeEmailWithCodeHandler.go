...
func ChangeEmailWithCodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChangeEmailWithCodeReq
		...
		l := account.NewChangeEmailWithCodeLogic(r.Context(), svcCtx)
		resp, err := l.ChangeEmailWithCode(&req)
