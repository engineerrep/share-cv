...
import (
	...
	"sharecvapi/app/api/internal/logic/account"
	"sharecvapi/app/api/internal/svc"
	"sharecvapi/app/api/internal/types"
)

func ChangeEmailWithPasswordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChangeEmailWithPasswordReq
		...
		l := account.NewChangeEmailWithPasswordLogic(r.Context(), svcCtx)
		resp, err := l.ChangeEmailWithPassword(&req)
