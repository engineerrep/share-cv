...
func GoogleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WebLoginGoogleReq
		...
		l := web.NewGoogleLogic(r.Context(), svcCtx)
		resp, err := l.Google(&req)
