...
import (
	...
	"sharecvapi/app/api/internal/logic/register"
	"sharecvapi/app/api/internal/svc"
	"sharecvapi/app/api/internal/types"
)

func CheckEmailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CheckEmailReq
		...
		l := register.NewCheckEmailLogic(r.Context(), svcCtx)
		resp, err := l.CheckEmail(&req)
