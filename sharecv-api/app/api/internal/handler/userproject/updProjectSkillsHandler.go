...
func UpdProjectSkillsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdUserProjectSkillsReq
		...
		l := userproject.NewUpdProjectSkillsLogic(r.Context(), svcCtx)
		resp, err := l.UpdProjectSkills(&req)
