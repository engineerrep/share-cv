...
func UpdateUserCountryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserCountryReq
		...
		l := userbase.NewUpdateUserCountryLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserCountry(&req)
