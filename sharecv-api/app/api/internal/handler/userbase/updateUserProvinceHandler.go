...
func UpdateUserProvinceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserProvinceReq
		...
		l := userbase.NewUpdateUserProvinceLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserProvince(&req)
