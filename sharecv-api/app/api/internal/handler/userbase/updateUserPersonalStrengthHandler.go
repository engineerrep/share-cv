...
func UpdateUserPersonalStrengthHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserPersonalStrengthReq
		...
		l := userbase.NewUpdateUserPersonalStrengthLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserPersonalStrength(&req)
