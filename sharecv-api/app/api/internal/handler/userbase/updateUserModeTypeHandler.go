...
func UpdateUserModeTypeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserModeTypeReq
		...
		l := userbase.NewUpdateUserModeTypeLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserModeType(&req)
