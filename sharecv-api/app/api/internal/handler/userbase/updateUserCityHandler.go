...
func UpdateUserCityHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserCityReq
		...
		l := userbase.NewUpdateUserCityLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserCity(&req)
