...
func UpdateUserWeightHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserWeightReq
		...
		l := userbase.NewUpdateUserWeightLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserWeight(&req)
