...
func UpdateUserLanguagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserLanguagesReq
		...
		l := userbase.NewUpdateUserLanguagesLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserLanguages(&req)
