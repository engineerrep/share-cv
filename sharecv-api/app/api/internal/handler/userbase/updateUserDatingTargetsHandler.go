...
func UpdateUserDatingTargetsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserDatingTargetsReq
		...
		l := userbase.NewUpdateUserDatingTargetsLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserDatingTargets(&req)
