...
func GetOtherUserInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := userbase.NewGetOtherUserInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetOtherUserInfo(&req)
