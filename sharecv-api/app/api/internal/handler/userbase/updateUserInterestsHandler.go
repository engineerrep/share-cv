...
func UpdateUserInterestsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserInterestsReq
		...
		l := userbase.NewUpdateUserInterestsLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserInterests(&req)
