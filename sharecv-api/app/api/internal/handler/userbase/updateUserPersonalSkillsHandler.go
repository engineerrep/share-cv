...
func UpdateUserPersonalSkillsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateUserPersonalSkillsReq
		...
		l := userbase.NewUpdateUserPersonalSkillsLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUserPersonalSkills(&req)
