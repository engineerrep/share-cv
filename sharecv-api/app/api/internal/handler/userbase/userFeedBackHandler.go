...
func UserFeedBackHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserFeedbackReq
		...
		l := userbase.NewUserFeedBackLogic(r.Context(), svcCtx)
		resp, err := l.UserFeedBack(&req)
