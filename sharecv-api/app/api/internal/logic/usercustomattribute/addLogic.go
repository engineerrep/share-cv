...
func (l *AddLogic) Add(req *types.ChangeUserCustomAttributeReq) (resp *types.IdResp, err error) {
	userId := ctxdata.GetUserIdFromCtx(l.ctx)

	var val model.AppUserCustomAttributes
	...
	if val.Id > 0 {
		err = l.svcCtx.AppUserCustomAttributesModel.Update(l.ctx, &val)
		if err != nil {
	...
	res, err := l.svcCtx.AppUserCustomAttributesModel.Insert(l.ctx, &val)
	if err != nil {
		return &types.IdResp{Id: 0}, nil
	}
